...
<tr>
	<td class="forumpostleft">
      <div class="author">
         ...
         <div class="poster"><a href="{$WWWROOT}{profile_url($post->poster)}"{if in_array($post->poster, $groupadmins)} class="groupadmin"{elseif $post->moderator} class="moderator"{/if}>{$post->poster|display_name}</a></div>
...
{if $post->edit}
        ...
        <ul>
            ...
            <li>
                <a href="{$WWWROOT}{profile_url($edit.editor)}"
