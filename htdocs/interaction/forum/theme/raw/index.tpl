        ...
        <td>
            ...
            <div class="inlinelist">
                ...
                {foreach from=$forum->moderators item=mod}
                    ...
                    <a href="{$WWWROOT}{profile_url($mod)}" class="moderator">{$mod|display_name:null:true}</a>
                {/foreach}
            </div>
            {/if}
        </td>
...
<div class="forummods">
    ...
    <span class="inlinelist">
        <a href="{$WWWROOT}{profile_url($groupadmin)}" class="groupadmin"><img src="{profile_icon_url user=$groupadmin maxheight=20 maxwidth=20}" alt=""> {$groupadmin|display_name}</a>
    </span>
    {/foreach}
</div>
