...
<div class="forumfooter">
    ...
    <span class="s inlinelist">
        <a href="{$WWWROOT}{profile_url($groupadmin)}"><img src="{$WWWROOT}thumb.php?type=profileicon&amp;maxsize=20&amp;id={$groupadmin}" alt=""></a>
        <a href="{$WWWROOT}{profile_url($groupadmin)}" class="groupadmin">{$groupadmin|display_name}</a>
    </span>
    {/foreach}
	{if $moderators}
    <div>
    <label>{str tag="moderatorslist" section="interaction.forum"}</label>
        ...
        <span class="s inlinelist">
            <a href="{$WWWROOT}{profile_url($mod)}"><img src="{$WWWROOT}thumb.php?type=profileicon&amp;maxsize=20&amp;id={$mod}" alt=""></a>
            <a href="{$WWWROOT}{profile_url($mod)}" class="moderator">{$mod|display_name}</a>
        </span>
        {/foreach}
    </div>
	{/if}
