...
<tr><td class="center">
    <div id="profilepict">
        <a href="{$WWWROOT}{profile_url($user)}"><img src="{profile_icon_url user=$user maxheight=100 maxwidth=100}" alt=""></a>
        <div id="profilename"><a href="{$WWWROOT}{profile_url($user)}">{$user|display_name}</a></div>
    </div>
    {if $loginas}
