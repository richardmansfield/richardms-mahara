{foreach from=$topics item=topic}
    <tr class="{cycle values='r0,r1'}">
      <td>
        ...
        <div class="s">
          <a href="{$WWWROOT}{$topic->groupurl}" class="topicgroup">{$topic->groupname|str_shorten_text:30:true}</a> >
      ...
      <td>
        ...
        <span class="s poster"><a href="{$WWWROOT}{profile_url($topic->poster)}">{$topic->poster|display_name}</a></span>
