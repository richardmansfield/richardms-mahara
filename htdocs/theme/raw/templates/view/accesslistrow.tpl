      ...
      {if $item.accessgroups}
        ...
        {foreach from=$item.accessgroups item=accessgroup name=ags}{strip}
          ...
          {elseif $accessgroup.accesstype == 'group'}
            <a href="{$WWWROOT}{$accessgroup.groupurl}">{$accessgroup.name}</a>{if $accessgroup.role} ({$accessgroup.roledisplay}){/if}
          ...
          {elseif $accessgroup.accesstype == 'user'}
            <a href="{$WWWROOT}{profile_url($accessgroup.id)}">{$accessgroup.id|display_name}</a>
          {/if}
