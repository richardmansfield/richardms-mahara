                ...
                <tr class="{cycle values='r0,r1'}">
                    ...
                    <td class="valign s center"><a href="{$WWWROOT}{profile_url($postinfo->author)}"><img src="{profile_icon_url user=$postinfo->author maxheight=20 maxwidth=20}" alt=""><br />{$postinfo->author|display_name}</a></td>
            	</tr>
                {/foreach}
        		</table>
                {else}
