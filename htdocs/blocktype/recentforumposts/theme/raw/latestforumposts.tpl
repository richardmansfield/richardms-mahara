    {if $foruminfo}
        ...
        {foreach from=$foruminfo item=postinfo}
            <tr class="{cycle values='r0,r1'}">
                ...
                <td class="valign s right"><a href="{$WWWROOT}{profile_url($postinfo->author)}"><img src="{profile_icon_url user=$postinfo->author maxheight=16 maxwidth=16}" alt=""> {$postinfo->author|display_name}</a>
                </td>
            </tr>
        {/foreach}
        </table>
