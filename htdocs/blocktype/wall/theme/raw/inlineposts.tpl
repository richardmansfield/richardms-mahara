<div id="wall" class="wall">
    ...
    {if $wallposts}
        ...
        {/if}
                <div class="userinfo"><img src="{profile_icon_url user=$wallpost maxheight=25 maxwidth=25}" alt="Profile Picture"><a href="{$WWWROOT}{$wallpost->profileurl}">{$wallpost->displayname}</a><span class="postedon"> - {$wallpost->postdate|format_date}</span></div>
